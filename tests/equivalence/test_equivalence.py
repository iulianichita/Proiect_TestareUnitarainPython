...
# pt metoda anuleaza_rezervare(rand, litera_loc)  

class TestAnuleaza_Rezervare:
    ...
    # R_1
    def test_rand_valid_business(self, sistem):
        sistem.rezerva_loc(2, 'A', 25, False)
        assert sistem.anuleaza_rezervare(2, 'A') == True

    # R_2
    def test_rand_valid_economy(self, sistem):
        sistem.rezerva_loc(5, 'A', 25, False)
        assert sistem.anuleaza_rezervare(5, 'A') == True

    # R_3
    @pytest.mark.parametrize("rand", [0, 12, -1])
    def test_rand_invalid_value_raises_value_error(self, sistem, rand):
        with pytest.raises(ValueError):
            sistem.anuleaza_rezervare(rand, 'A')
    ...
    # R_6
    def test_rand_valid_loc_deja_liber(self, sistem):
        assert sistem.anuleaza_rezervare(1, 'A') == False
    ...
    def test_rand_minim_valid(self, sistem):
        ...
        assert sistem.anuleaza_rezervare(1, 'A') == True

    # limita superioara: rand = 10
    def test_rand_maxim_valid(self, sistem):
        sistem.rezerva_loc(10, 'A', 25, False)
        assert sistem.anuleaza_rezervare(10, 'A') == True
    ...
    # L_1
    def test_litera_mare_valid(self, sistem):
        sistem.rezerva_loc(1, 'B', 25, False)
        assert sistem.anuleaza_rezervare(1, 'B') == True

    # L_2
    def test_litera_mica_valid(self, sistem):
        sistem.rezerva_loc(1, 'C', 25, False)
        assert sistem.anuleaza_rezervare(1, 'c') == True
    ...
    def test_loc_minim_valid(self, sistem, litera_loc):
        sistem.rezerva_loc(1, litera_loc, 25, False)
        assert sistem.anuleaza_rezervare(1, litera_loc) == True
