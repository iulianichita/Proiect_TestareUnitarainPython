...
TEST_DIR="${ROOT_DIR}/tests/circuits"
TEST_FILE="${TEST_DIR}/test_independent_circuits.py"
...
echo "Execut testele pentru circuite independente in ${TEST_DIR}"
"${PYTHON_BIN}" -m pytest "${TEST_FILE}" ${EXTRA_ARGS}

echo "Teste pentru circuite independente rulate."